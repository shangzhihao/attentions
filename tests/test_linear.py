...
def test_linear_forward_basic_shapes():
...
def test_linear_forward_flexible_input_dimensions():
...
def test_linear_forward_custom_feature_dimensions():
...
def test_linear_forward_with_padding_mask():
...
def test_linear_forward_with_attention_mask():
...
def test_linear_forward_attention_weights_properties():
...
def test_linear_forward_deterministic_behavior():
...
def test_linear_forward_batch_independence():
