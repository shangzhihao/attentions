...
def test_dilated_self_attention_forward_single_head():
...
def test_dilated_self_attention_forward_flexible_input():
...
def test_dilated_self_attention_dilation_pattern():
    """Test DilatedSelfAttention dilation pattern creation."""
    seq_len = 8
    attention = DilatedSelfAttention(d_model=32, dilation_rate=2)
...
def test_dilated_self_attention_different_dilation_rates():
    ...
    for dilation_rate in [1, 2, 3, 5]:
        ...
        mask = attention._create_dilated_mask(seq_len, x.device)
...
def test_dilated_self_attention_mask_handling():
...
def test_dilated_self_attention_temperature_scaling():
...
def test_dilated_self_attention_batch_independence():
